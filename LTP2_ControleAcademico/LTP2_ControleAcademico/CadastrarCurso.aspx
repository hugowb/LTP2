<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastrarCurso.aspx.cs" Inherits="LTP2_ControleAcademico.CadastrarCurso" %>
        ...
        <div class="container">
            <div class="row">
                <div class="jumbotron" id="jbt01">
                    ...
                    &nbsp;
                    <label>Código</label>
                    <asp:TextBox class="form-control" ID="txtCodido" name="txtCodido" runat="server"></asp:TextBox>
                    <label>Curso</label>
                    <asp:TextBox class="form-control" ID="txtCurso" runat="server"></asp:TextBox>
                    <label>Periodo</label>
                    <asp:TextBox class="form-control" ID="txtPeriodo" runat="server"></asp:TextBox>
                    <label>Duração</label>
                    <asp:TextBox class="form-control" ID="txtDuracao" runat="server"></asp:TextBox>
                    <label>Enade</label>
                    <asp:TextBox class="form-control" ID="txtEnade" runat="server"></asp:TextBox>
                    <br />
