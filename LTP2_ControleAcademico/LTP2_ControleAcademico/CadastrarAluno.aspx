<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CadastrarAluno.aspx.cs" Inherits="LTP2_ControleAcademico.CadastrarAluno" %>
        ...
        <div class="container">
            <div class="row">
                <div class="jumbotron" id="jbt01">
                    ...
                    <asp:TextBox ID="txtRA" runat="server" class="form-control"></asp:TextBox>
                    <label>Nome</label>
                    ...
                    <label>Ingressp</label>
                    <asp:TextBox ID="txtIngresso" runat="server" class="form-control"></asp:TextBox>
                    <br />
